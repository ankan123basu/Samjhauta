...
app = FastAPI(
    ...
    description="Two AI agents negotiate on behalf of two humans. Dual-model: Groq GPT-OSS 120B × Groq GPT-OSS 20B.",
    version="1.0.0",
)
...
async def root():
    return {
        ...
        "providers": {
            "agent_a": "Groq GPT-OSS 120B",
            "agent_b": "Groq GPT-OSS 20B",
        },
